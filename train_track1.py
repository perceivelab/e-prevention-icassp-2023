...
def parse():
    ...
    parser.add_argument('--root_dir', type=Path, default=Path("../datasets/SPGC_challenge_track_1_release/"))
    parser.add_argument('--fold', type=int, default=None)
    parser.add_argument('--split_path', type=Path, default=Path(f"data/track1/"))
