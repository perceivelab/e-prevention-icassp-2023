...
class Embeddings(nn.Module):
    ...
    def __init__(self, input_features, output_features, output_size, dropout=0.25):
        ...
        self.position_embeddings = PositionalEncoding(d_model=output_features)
    ...
    def forward(self, x):
        ...
        # add positional encoding (sum and dropout is done by the module)
        # x is expected in (L, B, D) shape
        x = x.permute(2, 0, 1)
